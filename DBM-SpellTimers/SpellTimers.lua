...
local default_settings = {
	...
	spells = {
		...
		{ spell = 19263, bartext = default_bartext, cooldown = 90 }, 	-- Deterrence
		{ spell = 45438, bartext = default_bartext, cooldown = 300 },	-- Ice Block
		{ spell = 1022, bartext = default_bartext, cooldown = 300 },	-- Hand of Protection
		{ spell = 6940, bartext = default_bartext, cooldown = 120 },	-- Hand of Sacrifice
		{ spell = 642, bartext = default_bartext, cooldown = 300 },		-- Divine Shield
		{ spell = 64205, bartext = default_bartext, cooldown = 120 },	-- Divine Sacrifice
		{ spell = 498, bartext = default_bartext, cooldown = 180 },		-- Divine Protection
		{ spell = 47788, bartext = default_bartext, cooldown = 180 }, 	-- Guardian Spirit
