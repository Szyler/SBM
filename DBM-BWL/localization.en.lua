...
L:SetMiscLocalization{
	YellPull = "Intruders have breached the hatchery! Sound the alarm! Protect the eggs at all costs!"--Yes this yell actually has a return and new line in it. as grabbed by transcriptor
}
-------------------
--  Vaelastrasz  --
-------------------
...
L:SetMiscLocalization{
	YellPull2 = "None of your kind should be here! You've doomed only yourselves!",
	YellPull3 = "None of your kind should be here!  You've doomed only yourselves!"--Yes this yell actually has a return and new line in it. as grabbed by transcriptor	
}
