...
local prewarnIncinerate			= mod:NewAnnounce("Incinerate Soon", 3, 23309)
local prewarnFrost				= mod:NewAnnounce("Frost Burn Soon", 3, 23189)
local prewarnIgnite				= mod:NewAnnounce("Ignite Flesh Soon", 3, 23316)
local prewarnCorrosive			= mod:NewAnnounce("Corrosive Acid Soon", 3, 23313)
local prewarnTime				= mod:NewAnnounce("Time Lapse Soon", 3, 23312)
