...
DBM_CORE_NEED_SUPPORT				= "Hey, bist du ein Programmierer oder gut in Fremdsprachen? Falls ja, benötigt das SBM-Team deine Hilfe, damit SBM das beste BossMod in WoW bleibt. Trete dem Team auf www.deadlybossmods.com bei oder sende eine E-Mail an tandanu@deadlybossmods.com oder nitram@deadlybossmods.com."

DBM_CORE_LOAD_MOD_ERROR				= "Fehler beim Laden von Boss Mods für %s: %s"
DBM_CORE_LOAD_MOD_SUCCESS			= "Boss Mods für '%s' geladen, für weitere Optionen gib /SBM in deinem Chatfenster ein!"
...
DBM_CORE_VERSIONCHECK_HEADER		= "Szyler Boss Mods - Versionen"
DBM_CORE_VERSIONCHECK_ENTRY			= "%s: %s (r%d)"
DBM_CORE_VERSIONCHECK_ENTRY_NO_DBM	= "%s: SBM nicht installiert"
DBM_CORE_VERSIONCHECK_FOOTER		= "%d Spieler mit Szyler Boss Mods gefunden"
DBM_CORE_YOUR_VERSION_OUTDATED      = "Deine Version von Szyler Boss Mods ist veraltet! Bitte besuche www.deadlybossmods.com, um die neueste Version herunterzuladen."
DBM_CORE_DISABLED_ICON_FUNCTION		= "Dein SBM setzt keine Zeichen mehr, weil deine Version veraltet ist. Bitte aktualisiere dein SBM so bald wie möglich und aktiviere die Zeichenfunktion wieder."

DBM_CORE_UPDATEREMINDER_HEADER		= "Deine Version von Szyler Boss Mods ist veraltet.\n Version %s (r%d) ist hier zum Download verfügbar:"
...
DBM_PIZZA_SYNC_INFO					= "|Hplayer:%1$s|h[%1$s]|h hat dir einen SBM-Timer geschickt: '%2$s'\n|HDBM:cancel:%2$s:nil|h|cff3588ff[Diesen Timer abbrechen]|r|h  |HDBM:ignore:%2$s:%1$s|h|cff3588ff[Pizza-Timer von %1$s ignorieren]|r|h"
DBM_PIZZA_CONFIRM_IGNORE			= "Willst du wirklich SBM-Timer von %s für diese Session ignorieren?"
DBM_PIZZA_ERROR_USAGE				= "Benutzung: /SBM [broadcast] timer <Sekunden> <text>"

DBM_CORE_ERROR_DBMV3_LOADED			= "Szyler Boss Mods läuft doppelt, da du SBMv3 und SBMv4 installiert und aktiviert hast!\nKlick auf \"Okay\" um SBMv3 zu deaktivieren und dein Interface neu zu laden.\nAußerdem solltest du deinen AddOn-Ordner aufräumen, indem du alle SBMv3 Mods löschst."
...
DBM_CORE_SLASHCMD_HELP				= {
	...
	"/SBM version: führt einen raidweiten Versionscheck durch (alias: ver)",
	"/SBM unlock: zeigt einen bewegbaren Timer an (alias: move)",
	"/SBM timer <x> <text>: startet einen <x> Sekunden langen SBM-Timer mit dem Namen <text>",
	"/SBM broadcast timer <x> <text>: schickt einen <x> Sekunden langen SBM-Timer mit dem Namen <text> an den Raid (benötigt (A) oder (L))",
	"/SBM break <min>: startet einen Pause-Timer für <min> Minuten. Schickt allen Raidmitgliedern mit SBM einen Pause-Timer (benötigt (A) oder (L)).",
	"/SBM help: zeigt diese Hilfe",
}
...
DBM_ARROW_ERROR_USAGE	= {
	"Benutzung von SBM-Arrow:",
	"/SBM arrow <x> <y>  erzeugt einen Pfeil, der auf bestimmte Koordinaten zeigt (0 < x/y < 100)",
	"/SBM arrow <player>  erzeugt einen Pfeil, der auf einen bestimmten Spieler in deiner Gruppe oder deinem Schlachtzug zeigt",
	"/SBM arrow hide  versteckt den Pfeil",
	"/SBM arrow move  macht den Pfeil beweglich",
}
