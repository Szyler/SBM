...
DBM_CORE_NEED_SUPPORT				= "¡Ey! ¿Eres un programador o eres bueno con los idiomas? Si es así, el Equipo SBM necesita tu ayuda para mantener el SBM como el mejor BossMod del WoW. Únete al equipo haciendo click en www.deadlybossmods.com o enviando un mensaje a tandanu@deadlybossmods.com o nitram@deadlybossmods.com."
...
DBM_CORE_VERSIONCHECK_HEADER		= "Szyler Boss Mods - Version"
DBM_CORE_VERSIONCHECK_ENTRY			= "%s: %s (r%d)"
DBM_CORE_VERSIONCHECK_ENTRY_NO_DBM	= "%s: SBM no instalado"
DBM_CORE_VERSIONCHECK_FOOTER		= "Encontrados %d jugadores con Szyler Boss Mods"
DBM_CORE_YOUR_VERSION_OUTDATED      = "¡Tu versión de Szyler Boss Mods es antigua! Por favor, visita www.deadlybossmods.com para bajarte la última versión."

DBM_CORE_UPDATEREMINDER_HEADER		= "La version de tu Szyler Boss Mods es antigua.\n Version %s (r%d) disponible para descargar aqui:"
DBM_CORE_UPDATEREMINDER_FOOTER		= "Presiona Contro+C para copiar el link de la descarga."
DBM_CORE_UPDATEREMINDER_NOTAGAIN	= "Mostrar popup si hay nueva version de Szyler Boss Mods"
...
DBM_PIZZA_ERROR_USAGE				= "Usa: /SBM [broadcast] timer <time> <text>"

DBM_CORE_ERROR_DBMV3_LOADED			= "Szyler Boss Mods is running twice because you have TBMv3 and TBMv4 installed and enabled!\nClick \"Okay\" to disable TBMv3 and reload your interface.\nYou should also clean up your AddOns folder by deleting the old TBMv3 folders."

DBM_CORE_MINIMAP_TOOLTIP_HEADER		= "SBM-Español"
...
DBM_CORE_SLASHCMD_HELP				= {
	...
	"/SBM version: comprueba la versión de SBM de toda la banda (alias: ver)",
	"/SBM unlock: muestra una barra de estado desplazable (alias: move)",
	"/SBM timer <x> <text>: Muestra un contador de <x> segundos con el nombre <text>",
	"/SBM broadcast timer <x> <text>: Muestra un contador de <x> segundos con el nombre <text> a la banda (requiere lider/ayudante)",
	"/SBM break <min>: Empieza un descanso de <min> minutos. Muestra a todos los miembros de banda con SBM un contador de descanso (requiere lider/ayudante).",
	"/SBM help: muestra esta ayuda",
}
...
DBM_ARROW_ERROR_USAGE	= {
	"Uso de SBM-Arrow:",
	"/SBM arrow <x> <y>: Crea una flecha que apunta a una dirección específica (0 < x/y < 100)",
	"/SBM arrow <jugador>: Crea una flecha que apunta a un miembro específico de la banda",
	"/SBM arrow hide: Oculta la flecha",
	"/SBM arrow move: Hace la flecha movible",
}
