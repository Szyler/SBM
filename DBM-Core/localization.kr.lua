...
DBM_CORE_NEED_SUPPORT				= "안녕하세요. OBM Team입니다. 만약 프로그래밍 또는 언어에 대해 잘 아신다면, OBM Team에 어떤 도움이든 주실 수 있습니다. 만약, 한글화 혹은 코드 수정에 관해 건의/수정 사항이 있다면 wow.somegate.com 또는 에이그윈(호드) 흑묘서희에게 연락바랍니다. OBM BossMods Team에 참가하고 싶다면 www.deadlybossmods.com 또는 tandanu@deadlybossmods.com 또는 nitram@deadlybossmods.com에 연락 바랍니다. 물론, 영어를 매우 잘하셔야겠죠?"
...
DBM_CORE_YOUR_VERSION_OUTDATED      = "당신의 OBM 버전이 오래되었습니다! www.deadlybossmods.com 또는 wow.somegate.com(korean)에 접속하셔셔 마지막 버전을 다운로드 받으셔요."
...
DBM_PIZZA_SYNC_INFO					= "|Hplayer:%1$s|h[%1$s]|h님이 당신에게 OBM 타이머 보냄: '%2$s'\n|HDBM:cancel:%2$s:nil|h|cff3588ff[타이머 취소]|r|h  |HDBM:ignore:%2$s:%1$s|h|cff3588ff[%1$s 타이머 무시]|r|h"
DBM_PIZZA_CONFIRM_IGNORE			= "현재 세션에서 %s님이 보낸 OBM 타이머를 무시하도록 하겠습니까?"
DBM_PIZZA_ERROR_USAGE				= "사용법: /obm [broadcast] timer <시간> <글자>"

DBM_CORE_ERROR_DBMV3_LOADED			= "OAK Boss Mods 가 실행중에 있습니다.\n당신께서 OBMv3 와 OBMv4를 동시에 설치하여 이런 상황이 발생한 것 같습니다.\n\"수락\"을 클릭하시면 OBMv3를 차단하고, UI가 다시시작 될 것입니다.\n또한, 애드온 폴더내에 존재하고 있는 OBMv3 폴더를 삭제하시길 권장합니다."
...
DBM_CORE_SLASHCMD_HELP				= {
	"사용 가능한 명령어:",
	"/obm version: 공격대 전체 버전 체크 (줄임말: ver)",
	"/obm unlock: 상태 바 타이머를 움직일 수 있도록 보여줍니다.(줄임말: move)",
	"/obm timer <숫자> <글자>: <숫자> 초만큼 진행되는 <글자>바가 생성 됨.",
	"/obm broadcast timer <숫자> <글자>: <숫자> 초만큼 진행되는 <글자>바를 공격대에 알립니다.(공격대 권한이 있을 경우만 작동)",
	"/obm break <min>: <min>분 동안 타이머를 작동합니다.  모든 공격대원에게 OBM이 발송하는 쉬는 시간 타이머를 보냅니다.",	
	"/obm help: 현재 보고 있는 도움말.",
}
...
DBM_ARROW_ERROR_USAGE	= {
	"OBM-Arrow 사용법:",
	"/obm arrow <x> <y>  특정 좌표(X/Y)에 화살표를 만듭니다.(0 < x/y < 100)",
	"/obm arrow <player>  당신이 속한 파티 또는 공격대의 특정 플레이어를 가르키는 화살표를 만듭니다.",
	"/obm arrow hide  화살표를 숨깁니다.",
	"/obm arrow move  화살표를 움직이도록 합니다.",
	"/obm arrow target 대상을 가르키는 화살표를 만듭니다.",
	"/obm arrow focus  주시대상을 가르키는 화살표를 만듭니다.",
}
