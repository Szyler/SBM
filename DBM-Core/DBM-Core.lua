...
-------------------------------
DBM = {
	Revision = ("$Revision: 1290 $"):sub(12, -3),
	Version = "1.29",
	DisplayVersion = "1.29", -- the string that is shown as version
	ReleaseRevision = 1290 -- the revision of the latest stable version that is available (for /obm ver2)
}
