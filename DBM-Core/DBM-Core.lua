...
-------------------------------
DBM = {
	Revision = ("$Revision: 1300 $"):sub(12, -3),
	Version = "1.30",
	DisplayVersion = "1.30", -- the string that is shown as version
	ReleaseRevision = 1300 -- the revision of the latest stable version that is available (for /obm ver2)
}
