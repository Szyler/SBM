...
DBM_CORE_NEED_SUPPORT				= "Are you good with programming or languages? If yes, the SBM team needs your help to keep SBM the best boss mod for WoW. Join the team by visiting www.deadlybossmods.com or sending a message to tandanu@deadlybossmods.com or nitram@deadlybossmods.com."

DBM_CORE_LOAD_MOD_ERROR				= "Error while loading boss mods for %s: %s"
DBM_CORE_LOAD_MOD_SUCCESS			= "Loaded '%s' boss mods. For more options, type /sbm in your chat."
...
-- SBMTV_CORE_COMBAT_STARTED			= "Encounter started: %s."
-- SBMTV_CORE_BOSS_DOWN				= "Encounter completed: %s!"
-- SBMTV_CORE_COMBAT_ENDED				= "Encounter failed: %s."
...
DBM_ARROW_ERROR_USAGE	= {
	"DBM-Arrow usage:",
	"/sbm arrow <x> <y>  creates an arrow that points to a specific locataion (0 < x/y < 100)",
	"/sbm arrow <player>  creates and arrow that points to a specific player in your party or raid",
	"/sbm arrow hide  hides the arrow",
	"/sbm arrow move  makes the arrow movable",
}
