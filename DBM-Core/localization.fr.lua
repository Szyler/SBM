...
DBM_CORE_VERSIONCHECK_ENTRY_NO_DBM	= "%s: SBM non installé"
DBM_CORE_VERSIONCHECK_FOOTER		= "a trouvé %d joueurs avec Szyler Boss Mods"
DBM_CORE_YOUR_VERSION_OUTDATED      = "Votre version de Szyler Boss Mods est périmé! Merci de visiter www.deadlybossmods.com pour avoir la dernière version."
...
DBM_CORE_UPDATEREMINDER_HEADER		= "Votre version de Szyler Boss Mods est périmée.\n Version %s (r%d) disponible ici:"
DBM_CORE_UPDATEREMINDER_FOOTER		= "Faites Ctrl-C pour copier le lien votre presse-papier."
DBM_CORE_UPDATEREMINDER_NOTAGAIN	= "Montre une annonce quand une nouvelle version de SBM est disponible."
...
DBM_CORE_SLASHCMD_HELP				= {
	...
	"/SBM version: Vérifie la version du raid (alias: ver)",
	"/SBM unlock: Affiche un Timer Status déplacable (alias: move)",
	"/SBM timer <x> <text>: Commence un <x> second Timer Pizza avec le nom <text>",
	"/SBM broadcast timer <x> <text>: Diffuse un Timer Pizza de <x> secondes avec le nom <text> au raid (Nécessite d'être promu ou leader)",
	"/SBM break <min>: Démarre un timer de pause pour <min> minutes. Envoie à tous les membres du raid avec SBM ce timer de pause (Nécessite d'être promu ou leader).",
	"/SBM help: Affiche l'aide",
}
...
DBM_ARROW_ERROR_USAGE	= {
	"SBM-flèche usage:",
	"/SBM flèche <x> <y> crée une flèche qui pointe vers une locataion spécifiques (0 < x/y < 100)",
	"/SBM flèche <player> crée une flèche qui pointe vers un joueur précis dans votre groupe ou raid",
	"/SBM flèche cache la flèche",
	"/SBM flèche fait déplacer",
}
